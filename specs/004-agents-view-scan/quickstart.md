...
3. Open **ACE → Workspaces** → expand **Current Workspace** (or your project) → **Cursor** → **Agent definitions**.
...
3. Open **ACE → Agents** → expand **Cursor** (or Claude / Global) → **Agent definitions**.
